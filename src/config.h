...
#define USE_CACHE 1
//! The below was changed so the days now last longer
#define DAY_LENGTH 1800
...
#define CRAFT_KEY_FORWARD2 'O'
#define CRAFT_KEY_BACKWARD 'S'
#define CRAFT_KEY_BACKWARD2 'L'
#define CRAFT_KEY_LEFT 'A'
#define CRAFT_KEY_LEFT2 'K'
#define CRAFT_KEY_RIGHT 'D'
#define CRAFT_KEY_RIGHT2 ';'
